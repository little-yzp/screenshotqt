...
struct qt_meta_stringdata_PicView_t {
    QByteArrayData data[1];
    char stringdata0[8];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PicView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PicView_t qt_meta_stringdata_PicView = {
    {
QT_MOC_LITERAL(0, 0, 7) // "PicView"
...
QT_INIT_METAOBJECT const QMetaObject PicView::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_PicView.data,
    qt_meta_data_PicView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *PicView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PicView.stringdata0))
